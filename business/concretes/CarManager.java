...
//	@Override
//	public DataResult<CarListDto> getCarListDto(int id) {
...
//	
	...
	@Override
	public DataResult<CarListDtoProj> getCarListDto(int id) {
		var result = this.carDao.getCarByCarId(id);
		if(result.isEmpty()) {
			return new ErrorDataResult<CarListDtoProj>(Messages.CARNOTFOUND);
		}
		return new SuccessDataResult<CarListDtoProj>(result.get());
